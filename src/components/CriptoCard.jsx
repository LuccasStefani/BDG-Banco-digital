...
const CriptoCard = () => {
  return (
    <section className="w-full bg-cover bg-center py-32  sm:px-16 rounded-[30px] my-10 min-h-[700px] background_image">
      <div className="max-w-[1380px] mx-auto flex flex-col-reverse md:flex-row items-center justify-between gap-10">
        ...
        <div className="flex-1 text-white">
          ...
          <ul className="text-dimWhite text-[16px] leading-loose list-disc list-inside mt-4">
            <li>- Biticoin a moeda mais valorizada do mundo</li>
            <li>- Tether (USDT)</li>
            <li>- BULLDOGITO</li>
          </ul>
        </div>
